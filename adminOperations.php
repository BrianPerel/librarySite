	...
	<body>
		...
		<?php 
			...
			if(isset($_POST['deleteItem'])) {
				...
				echo "<form action='completeDeletion.php' action='POST' style='border: solid 0.1px; margin: 1% 25% 1% 25%; padding: 2% 0% 2% 0%' autocomplete='off'>";
			...
			if(isset($_POST['addItem'])) {
				...
				echo "<form action='addCompletion.php' action='POST' style='border: solid 0.1px; margin: 1% 35% 1% 35%; padding: 2% 0% 2% 0%' autocomplete='off'>";
