...
<html>
	...
	<body>
		...
		<div class="class3">		
			...
			<img src="icons/2.png" id="pic1" width="150px" height="150px"></img>
			<img src="icons/3.jpg" id="pic1" width="150px" height="150px"></img>
			
			<center><p id="BodyText">Location: 100 State Street Framingham, MA 01701. We are located just off of Route 9 and about 1.5 miles from Mass Pike exit 12.</p>
