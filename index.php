<?php 
	...
	$timeInactive = 1800; // 30 mins = 1800 secs 
...
?>
<div class="class3">		
	<form class="example" action="itemSearch.php" method="post" style="margin:auto;max-width:375px">
		<input autofocus type="text" placeholder="Search the library's catalog..." name="item_name" autocomplete='off' required></input>
	...
	<br>Saturday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;9AM - 5PM<br><br><br></p></center>
	...
	<img src="images/5.jpg" height="300" width="400"></img>
</div>
