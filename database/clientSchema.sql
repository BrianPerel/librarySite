...
('Guiness World Records 2020', 'Guinness World Records', '657-56-43564-34-2', 'Guinness World Records', '2020', 'adult', 'Fully revised and updated, the record-breaking compendium of superlatives is back and bursting with facts, figures and incredible stories each one selected to inspire you to learn about the fascinating world we live and to break records of your own', 'ebook', 'S213.132 C', 'Available', 'Framingham State University', '16.46', 'No', '../images/records.jpg'),
...
('Splinter Cell Blacklist', 'Ubisoft', '768-67-45645-34-6', 'Ubisoft', '2013', 'adult', 'Tom Clancy\'s Splinter Cell: Blacklist is an action-adventure stealth video game developed by Ubisoft Toronto and published by Ubisoft. The seventh installment of the Tom Clancy\'s Splinter Cell series, it is the sequel of Splinter Cell: Conviction', 'video-game', 'E657.345 Y', 'Available', 'Framingham State University', '19.99', 'No', '../images/sp.jpg'),
